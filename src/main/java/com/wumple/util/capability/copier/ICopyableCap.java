...
public interface ICopyableCap<T extends com.wumple.util.capability.copier.ICopyableCap<T>>
{
    ...
    default void copyFrom2(com.wumple.util.capability.copier.ICopyableCap<T> other, World world)
    {
