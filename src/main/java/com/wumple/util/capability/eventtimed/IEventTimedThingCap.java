...
public interface IEventTimedThingCap<W extends IThing, T extends Expiration> extends IThingCap<W>, ICopyableCap<com.wumple.util.capability.eventtimed.IEventTimedThingCap<W,T>>, ITooltipProvider
{
    public T newT();
    public LazyOptional< ? extends com.wumple.util.capability.eventtimed.IEventTimedThingCap<W,T>> getCap(ICapabilityProvider stack);
    ...
    */
    ...
    default ItemStack check(World world, ItemStack stack)
    {
        LazyOptional<? extends com.wumple.util.capability.eventtimed.IEventTimedThingCap<W,T>> lcap = getCap(stack);
    ...
    */
    ...
    @Override
    default void copyFrom(com.wumple.util.capability.eventtimed.IEventTimedThingCap<W, T> other, World world)
    {
        // Avoid cheating from crafting or break rotting items
    ...
    default void handleCraftedTimers(World world, IInventory craftMatrix, ItemStack crafting)
    {
        ...
        for (int i = 0; i < slots; i++)
        {
            ...
            LazyOptional<? extends com.wumple.util.capability.eventtimed.IEventTimedThingCap<W,T>> cap = getCap(thing);
