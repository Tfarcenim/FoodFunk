...
public class XShapelessRecipe implements ICraftingRecipe
{
	...
	public static class Serializer<T extends com.wumple.util.crafting.XShapelessRecipe>
			extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>>
			implements IRecipeSerializer<com.wumple.util.crafting.XShapelessRecipe>
	{
		...
		public com.wumple.util.crafting.XShapelessRecipe read(ResourceLocation recipeId, JsonObject json)
		{
		...
		public com.wumple.util.crafting.XShapelessRecipe read(ResourceLocation recipeId, PacketBuffer buffer)
		{
		...
		public void write(PacketBuffer buffer, com.wumple.util.crafting.XShapelessRecipe recipe)
		{
